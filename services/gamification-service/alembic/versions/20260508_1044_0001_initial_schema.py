...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('slug', sa.Enum('warrior', 'mage', 'rogue', 'engineer',
                                  name='charactertypeslugs', schema=SCHEMA), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('rarity', sa.Enum('common', 'rare', 'epic', 'legendary',
                                    name='badgerarity', schema=SCHEMA),
                  nullable=False, server_default='common'),
        sa.Column('visibility', sa.Enum('open', 'locked', 'hidden',
                                        name='cosmeticvisibility', schema=SCHEMA),
                  nullable=False, server_default='open'),
        sa.Column('unlock_type', sa.Enum('none', 'quest', 'achievement', 'level', 'admin',
                                         name='unlocktype', schema=SCHEMA),
    ...
    op.create_table(
        ...
        sa.Column('description', sa.Text, nullable=True),
        sa.Column('quest_type', sa.Enum('personal', 'team', 'daily', 'skill', 'integration',
                                        name='questtype', schema=SCHEMA),
                  nullable=False, server_default='personal'),
        sa.Column('difficulty', sa.Enum('easy', 'medium', 'hard', 'epic',
                                        name='questdifficulty', schema=SCHEMA),
                  nullable=False, server_default='medium'),
        sa.Column('status', sa.Enum('draft', 'active', 'archived',
                                    name='queststatus', schema=SCHEMA),
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('in_progress', 'completed', 'failed', 'abandoned',
                                    name='userqueststatus', schema=SCHEMA),
    ...
    op.create_table(
        ...
        sa.Column('source', sa.Enum(
            'quest', 'badge', 'github_commit', 'github_pr', 'jira_task',
            'admin', 'penalty', 'character_level',
