...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('slug', sa.Enum('warrior','mage','rogue','engineer', name='charactertypeslugs'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('character_type_id', postgresql.UUID(as_uuid=False),
                  sa.ForeignKey('character_types.id'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('visibility', sa.Enum('open','locked','hidden', name='cosmeticvisibility'), nullable=False, server_default='open'),
        sa.Column('unlock_type', sa.Enum('none','quest','achievement','level','admin', name='unlocktype'), nullable=False, server_default='none'),
    ...
    op.create_index('ix_cosmetic_items_slot', 'cosmetic_items', ['slot'])
    op.create_index('ix_cosmetic_items_visibility', 'cosmetic_items', ['visibility'])
    ...
    op.create_table(
        ...
        sa.Column('cosmetic_item_id', postgresql.UUID(as_uuid=False),
                  sa.ForeignKey('cosmetic_items.id', ondelete='CASCADE'), nullable=False),
        sa.Column('slot', sa.Enum(
            'hair','head','head_accessory','eyes','face_expression',
            'torso','torso_accessory','legs','weapon_main','weapon_secondary',
            name='cosmeticslot'
    ...
    op.create_index('ix_character_equipment_character', 'character_equipment', ['character_id'])
    ...
    op.create_index('ix_unlocked_cosmetics_user', 'unlocked_cosmetics', ['user_id'])
    ...
    op.create_table(
        ...
        sa.Column('description', sa.Text, nullable=True),
        sa.Column('quest_type', sa.Enum('personal','team','daily','skill','integration', name='questtype'), nullable=False, server_default='personal'),
        sa.Column('difficulty', sa.Enum('easy','medium','hard','epic', name='questdifficulty'), nullable=False, server_default='medium'),
        sa.Column('status', sa.Enum('draft','active','archived', name='queststatus'), nullable=False, server_default='active'),
    ...
    op.create_index('ix_quests_type', 'quests', ['quest_type'])
    ...
    op.create_table(
        ...
        sa.Column('status', sa.Enum('in_progress','completed','failed','abandoned', name='userqueststatus'), nullable=False, server_default='in_progress'),
    ...
    op.create_table(
        ...
        sa.Column('badge_id', postgresql.UUID(as_uuid=False),
                  sa.ForeignKey('badges.id', ondelete='CASCADE'), nullable=False),
